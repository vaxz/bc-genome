...
class Gene
{
     ...
     * @return boolean O if the Gene Object is a reference gene
	 *                 1 if the Gene Object is not a reference gene
     */
     ...
     * @return Gene
     */
    public function setGeneLocus(\bcGen\MainBundle\Entity\Locus $locus)
    {
    ...
    {
        $this->geneProteins[] = $geneProteins;
	 ...
	 * The order choosen is : BCIN > B0510 > BC1G > BCT4 > BOFU
	 *  
	 * @param Gene $gene1
	 * @param Gene $gene2
	...
	public static function geneAccessionComp ( Gene $gene1, Gene $gene2 )
	{
		...
		else
		{
			...
			{	
				if( substr_compare( $accessionNum2, "BCIN", 0, 4, true ) == 0 OR 
				    substr_compare( $accessionNum2, "B0510", 0, 4, true ) == 0 )
				     $tmp = 1;
				else $tmp = -1;
