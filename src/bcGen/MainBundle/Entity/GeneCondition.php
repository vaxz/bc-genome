...
/**
 * GeneCondition class allows the creation of GeneCondition object and correponds to a table in the database : bc_gen_db.
 * It ensures the link between Gene and Condition entities and gives information on experimental expression results
 *
