...
class Protein {
	 ...
	 * @var string
	 * 
	 * @ORM\Column(name="protein_accession", type="string", length=255, nullable=TRUE)
	 */
	 ...
	 * @var string
	 * 
	 * @ORM\Column(name="protein_seq", type="text", nullable=TRUE)
	 */
	private $proteinSeq;
	 ...
	 * @var integer
	 * 
	 * @ORM\ManyToOne( targetEntity="bcGen\MainBundle\Entity\Gene", inversedBy="geneProteins" )
