...
class LocusRepository extends EntityRepository
{
	 ...
	 * @return \bcGen\MainBundle\Entity\Locus|null The reference of a Locus object or
	 *                                            null if the query gets nothing from the database
	 */	
	public function findOneLocusFromAccessionNum( $geneAccession )
	{
        $query = $this->createQueryBuilder( 'l' )->from( 'bcGen\MainBundle\Entity\Gene', 'g' );
