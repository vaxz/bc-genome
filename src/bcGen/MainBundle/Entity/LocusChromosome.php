 ...
 * to a table in the database : bc_gen_db. It ensures the link between Locus and Chromosome entities
...
class LocusChromosome
{
     ...
     * @return LocusChromosome
     */
    public function setLocusChromosomeFkChromosome(\bcGen\MainBundle\Entity\Locus $chromosome)
    {
